package com.maloy.muzza.service
...
import com.maloy.innertube.models.bodies.PlayerBody
...
import com.maloy.muzza.models.Event
import com.maloy.muzza.models.QueuedMediaItem
import com.maloy.muzza.query
import com.maloy.muzza.utils.InvincibleService
import com.maloy.muzza.utils.RingBuffer
import com.maloy.muzza.utils.TimerJob
import com.maloy.muzza.utils.YouTubeRadio
import com.maloy.muzza.utils.activityPendingIntent
import com.maloy.muzza.utils.broadCastPendingIntent
import com.maloy.muzza.utils.exoPlayerDiskCacheMaxSizeKey
import com.maloy.muzza.utils.findNextMediaItemById
...
import com.maloy.muzza.utils.isAtLeastAndroid13
...
import com.maloy.muzza.utils.isShowingThumbnailInLockscreenKey
import com.maloy.muzza.utils.mediaItems
import com.maloy.muzza.utils.persistentQueueKey
import com.maloy.muzza.utils.preferences
import com.maloy.muzza.utils.queueLoopEnabledKey
import com.maloy.muzza.utils.resumePlaybackWhenDeviceConnectedKey
import com.maloy.muzza.utils.shouldBePlaying
import com.maloy.muzza.utils.skipSilenceKey
import com.maloy.muzza.utils.timer
import com.maloy.muzza.utils.trackLoopEnabledKey
import com.maloy.muzza.utils.volumeNormalizationKey
...
class PlayerService : InvincibleService(), Player.Listener, PlaybackStatsListener.Callback,
    ...
    private value class Action(val value: String) {
        ...
        companion object {
            val pause = Action("com.maloy.muzza.pause")
            val play = Action("com.maloy.muzza.play")
            val next = Action("com.maloy.muzza.next")
            val previous = Action("com.maloy.muzza.previous")
        }
    }
