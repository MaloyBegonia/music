...
import com.maloy.music.internal
import com.maloy.music.path
...
fun DatabaseSettings() {
    ...
    val eventsCount by remember {
        com.maloy.music.Database.eventsCount().distinctUntilChanged()
    ...
    val backupLauncher =
        rememberLauncherForActivityResult(ActivityResultContracts.CreateDocument("application/vnd.sqlite3")) { uri ->
            ...
            com.maloy.music.query {
                com.maloy.music.Database.checkpoint()

                context.applicationContext.contentResolver.openOutputStream(uri)
                    ?.use { outputStream ->
                        FileInputStream(com.maloy.music.Database.internal.path).use { inputStream ->
    ...
    val restoreLauncher =
        rememberLauncherForActivityResult(ActivityResultContracts.OpenDocument()) { uri ->
            ...
            com.maloy.music.query {
                com.maloy.music.Database.checkpoint()
                com.maloy.music.Database.internal.close()

                context.applicationContext.contentResolver.openInputStream(uri)
                    ?.use { inputStream ->
                        FileOutputStream(com.maloy.music.Database.internal.path).use { outputStream ->
                            inputStream.copyTo(outputStream)
                        }
                    }
    ...
    Column(
        ...
        SettingsEntry(
            ...
            onClick = { com.maloy.music.query(com.maloy.music.Database::clearEvents) }
        )
