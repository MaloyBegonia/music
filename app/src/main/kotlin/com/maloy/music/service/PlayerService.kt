package com.maloy.music.service
...
import com.maloy.music.utils.TimerJob
import com.maloy.music.utils.YouTubeRadio
import com.maloy.music.utils.activityPendingIntent
import com.maloy.music.utils.broadCastPendingIntent
import com.maloy.music.utils.exoPlayerDiskCacheMaxSizeKey
import com.maloy.music.utils.findNextMediaItemById
...
class PlayerService : InvincibleService(), Player.Listener, PlaybackStatsListener.Callback,
    ...
    private value class Action(val value: String) {
        ...
        companion object {
            val pause = Action("com.maloy.music.pause")
            val play = Action("com.maloy.music.play")
            val next = Action("com.maloy.music.next")
            val previous = Action("com.maloy.music.previous")
        }
    }
